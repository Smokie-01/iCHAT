...
class _ChatUserCardState extends State<ChatUserCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onLongPress: () {
        ...
        //   APIs.removeUser(widget.user.id).then((value) {});

        // CustomDialog.snackbar(context, "User Deleted Succesfully");
      },
      child: Card(
  ...
  void _confirmDeleteBottomsheet() {
    showDialog(
        context: context,
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () async {
                  await APIs.removeUser(widget.user.id).then((value) {
                    CustomDialog.snackbar(context, "User Deleted Succesfully");
                  });
                  Navigator.pop(context);
                },
